    ...
    for batch_idx, method_batch in enumerate(PLOT_METHODS):
        for combined_plot_settings, combined_plot_titles in zip(
            ...
            if "x5" in setting:
                ...
                raise ValueError()
            fig.savefig(OUTPUT_DIR_PLOTS / f"arch_{batch_idx}.pdf")
            # fig.savefig(OUTPUT_DIR_PLOTS / f"arch_{n_tasks}_{batch_idx}.png")
