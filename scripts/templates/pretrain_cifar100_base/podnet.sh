...
python src/main_incremental.py \
    ...
    --seed ${seed} \
    --network resnet32 \
    --pod-fmap-layers layer1 layer2 layer3 \
    ...
    --nb-proxy ${nb_proxy} \
    --log disk wandb \
    --results-path ./results/CIFAR100x${num_tasks}/${approach}_ex${num_exemplars}_lamb_spatial_${lamb_pod_spatial}_lamb_flat_${lamb_pod_flat}_ft_epochs_${nepochs_finetuning}_lr_${lr_finetuning_factor}_nb_proxy_${nb_proxy}/seed${seed} \
    --tags ${tag}
