...
for seed in 0 1 2; do
    for num_tasks in 5 10; do
        for ic_config in cifar100_resnet32_sdn cifar100_resnet32_dense; do
            ...
            #             lamb=1.0
            #             lamb_a=1.0
            #             sbatch -A plgimprmoe-gpu-a100 -p plgrid-gpu-a100 scripts/templates/cifar100_ee/ancl.sh ${num_tasks} ${seed} ${num_exemplars} ${lamb} ${lamb_a} ${ic_config}
            #             lamb=2.0
            #             lamb_a=2.0
            #             sbatch -A plgimprmoe-gpu-a100 -p plgrid-gpu-a100 scripts/templates/cifar100_ee/ancl.sh ${num_tasks} ${seed} ${num_exemplars} ${lamb} ${lamb_a} ${ic_config}
            #             lamb=0.5
            ...
            # ER
            num_exemplars=2000
            sbatch -A plgimprmoe-gpu-a100 -p plgrid-gpu-a100 scripts/templates/cifar100_ee/er.sh ${num_tasks} ${seed} ${num_exemplars} ${ic_config}
