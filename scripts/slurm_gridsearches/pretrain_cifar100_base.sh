...
for seed in 1 2; do
    for num_tasks in 6 11; do
        ...
        #         num_exemplars=2000
        #         lamb=0.25
        #         sbatch -A plgdynamic2-gpu-a100 -p plgrid-gpu-a100 scripts/templates/pretrain_cifar100_base/icarl.sh ${num_tasks} ${seed} ${num_exemplars} ${lamb}
        #         lamb=0.5
        #         sbatch -A plgdynamic2-gpu-a100 -p plgrid-gpu-a100 scripts/templates/pretrain_cifar100_base/icarl.sh ${num_tasks} ${seed} ${num_exemplars} ${lamb}
        #         lamb=0.75
        #         sbatch -A plgdynamic2-gpu-a100 -p plgrid-gpu-a100 scripts/templates/pretrain_cifar100_base/icarl.sh ${num_tasks} ${seed} ${num_exemplars} ${lamb}
        ...
        # Joint
        #         sbatch -A plgdynamic2-gpu-a100 -p plgrid-gpu-a100 scripts/templates/pretrain_cifar100_base/joint.sh ${num_tasks} ${seed}
